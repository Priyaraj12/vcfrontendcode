...
(function() {
	...
	angular
			...
			/* Remove	initial modal for Builder Portal														 
	...
	*/		
								...
								$scope.builderList =
										[ 
											{ name: 'Alliance Group', id: 286 }
										];
								$scope.builderprojectList =
										[ 
											{ name: 'Galeria Residences', id: 437 },
											{ name: 'Humming Gardens', id: 440 },
											{ name: 'Jasmine Springs', id: 441 },
											{ name: 'Orchid Springs', id: 442 },  
											{ name: 'Villa Belvedere', id: 443 }
										];
								...
								$scope.Assets.refnum = $scope.Assets.productTypeId ? $scope.Assets.productTypeId : 1;
	/*modified for builder specific */			$scope.Assets.location = $scope.Assets.city ? $scope.Assets.city : 'Chennai';
								$scope.Assets.projectZip = $scope.assetinfo.projectZip;
						
	// commented for builder specific		$scope.Assets.projectName = $scope.assetinfo.projectName;
	/*added for builder specific */			$scope.Assets.projectName = $scope.assetinfo.projectName ? $scope.assetinfo.projectName : 'Narmada';
	...
	// commented for builder specific		$scope.Assets.builderName = $scope.assetinfo.builderName;
	/*added for builder specific */			$scope.Assets.builderName = $scope.assetinfo.builderName ? $scope.assetinfo.builderName : 'Arun Excello';
						...
						//		$scope.Assets.location = $scope.Assets.city;
								...
								$scope.Assets.loanTermId = $scope.Assets.loanTermId ? $scope.Assets.loanTermId : 240;
								...
								$scope.Assets.propertyIdentifierId = $scope.Assets.propertyIdentifierId? $scope.Assets.propertyIdentifierId : 1;
			...
			/* commented for builder specific

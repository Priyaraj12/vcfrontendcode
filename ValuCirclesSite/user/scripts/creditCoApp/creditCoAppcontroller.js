                     ...
                     function successCallback(response) {
                         ...
                         if(check != "{}"){
                             if (response.data.Result == 'Success') {
								 ...
								 //alert("anstype.."+$scope.ansType)
                                 var questionValue = questionData[2].split(":");//changed by Priya on 29-12-2022
								 $scope.question = questionValue[1];
								 //alert("question.." + $scope.question);
								 
								 var option1 = questionData[4];
								 var option1Data = option1.split(":");
								 //alert("option1.." + option1Data[1]);
								 //alert("option2.." + questionData[5]);
								 //alert("option3.." + questionData[6]);
								 var option4 = questionData[7];
								 var option4Data = option4.split("]");
								 //alert("option4.." + option4Data[0]);
                                 var ans = [];
								 ans[0]= option1Data[1].replace('[','');
								 ans[1] = questionData[5];
								 ans[2] = questionData[6];
								 ans[3] = option4Data[0].replace(']','');;								 
                                 $scope.ans = ans; 
								 //alert("answers.." + $scope.ans);								 
